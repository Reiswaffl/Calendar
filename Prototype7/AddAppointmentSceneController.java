...
public class AddAppointmentSceneController implements Initializable {
    ...
    public void add() throws TransformerException {
        ...
        if(main.AddAppiontment(date,period.getText(),content.getText()) == false){
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Zeitraum nicht frei");
            alert.setHeaderText(null);
            alert.setContentText("Dieser Zeitraum ist leider bereits mit einem anderen Termin belegt");
            alert.showAndWait();
        }
        jahr.clear();
        month = "--";
